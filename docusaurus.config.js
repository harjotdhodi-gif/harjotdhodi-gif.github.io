...
const config = {
  ...
  themeConfig: {
    ...
    navbar:{title:'Harjot Singh Dhodi',hideOnScroll:false,items:[
      ...
      {href:'/files/Harjot-Singh-Dhodi-CV.pdf',label:'Download CV',position:'right'},
